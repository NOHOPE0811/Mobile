...
import { View,
   ...
   RefreshControl, 
   TouchableOpacity,
   Image, Button, Modal, Linking } from 'react-native';
import styles from '../Component/Stylesheet/stylesList';
...
const LIST = () => {
  ...
  const renderItem = ({ item, index }) => (
    <Animated.View style={[styles.item, { transform: [{ scale: index === 0 ? animatedScale : 1 }] }]}>
      ...
      <Image source={require('../images/logoctu.png')} style={styles.itemImage} />
      ...
      <Modal animationType="slide" transparent={true} visible={isVisible}>
        <View style={styles.modalContainer}>
          ...
          <TouchableOpacity onPress={() => Linking.openURL(profileLink)}>
            <Image source={require('../images/logoctu.png')} style={styles.modalImage} />
